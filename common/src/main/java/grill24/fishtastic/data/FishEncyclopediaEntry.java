...
public record FishEncyclopediaEntry(Optional<String> lore, UnlockThresholds thresholds) {
    public record UnlockThresholds(int nameRevealCatches, int statsCatches,
                                    int spawnConditionsCatches, int loreCatches) {
        public static final UnlockThresholds DEFAULT = new UnlockThresholds(1, 5, 10, 25);
        public static final Codec<UnlockThresholds> CODEC = RecordCodecBuilder.create(i -> i.group(
                ...
                Codec.INT.optionalFieldOf("stats_catches", 5).forGetter(UnlockThresholds::statsCatches),
