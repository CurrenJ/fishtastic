...
public class FishTankItemModelFabric implements ItemModel {
    ...
    public FishTankItemModelFabric(ModelBaker baker, ResolvedModel frameModel, ResolvedModel sandModel,
    ...
    public record Unbaked() implements ItemModel.Unbaked {
        ...
        public ItemModel bake(ItemModel.BakingContext context, Matrix4fc transformation) {
            ...
            return new FishTankItemModelFabric(baker, frameModel, sandModel, glassModel, transformation);
        }
    }
}
